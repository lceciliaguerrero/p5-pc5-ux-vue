        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input id="firstName" class="form-control" type="text" name="firstName"
                   placeholder="Escriba su nombre de pila" v-model="nombrePila" aria-required="true">
          </div>
          <div class="col-md-6 mb-3">
            <label for="lastName">Apellidos</label>
            <input id="lastName" class="form-control" type="text" name="lastName"
                   placeholder="Escriba sus apellidos de pila" v-model="apellidoPila" aria-required="true">
          </div>
        </div>
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input id="username" class="form-control" type="text" name="username"
                   placeholder="Escriba su nombre de usuario" v-model="nombreUsuario" aria-required="true">
          </div>
        </div>
        <div class="mb-3">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="cc-text" v-model="nombreTarjeta"
                   placeholder="Escribe el nombre de la tarjeta" aria-required="true">
          </div>
          <div class="col-md-6 mb-3">
            <label for="cc-number">Numero de la Tarjeta</label>
            <input type="text" class="form-control" id="cc-number" v-model="numeroTarjeta"
                   placeholder="Escribe el numero de la tarjeta" aria-required="true">
          </div>
        </div>
        <div class="mb-3">
